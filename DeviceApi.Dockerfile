...
COPY --from=core-build-step /build/Boondocks.Services.Device.WebApi/bin/Debug/netcoreapp2.0/ubuntu.16.04-x64/publish/ /opt/boondocks/
...
CMD ["dotnet", "Boondocks.Services.Device.WebApi.dll"]