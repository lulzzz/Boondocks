...
namespace Boondocks.Auth.Tests
{
   ...
   public class DeviceAuthProviderUnitTests
   {
       ...
       {
           var deviceId = Guid.Parse("4C0E880E-255A-4967-8A00-EED604F29417");
           var deviceKey = Guid.Parse("02635B4E-ED6C-48D7-A744-547B4B5B370A");
    ...
    //        var authContext = AuthContext.FromService(
    //            "mock-service-api", 
    //            new Dictionary<string, string> {var deviceId = Guid.Parse("B89A2796-C734-4586-9167-DFC0458B8172");
    //        var deviceKey = Guid.Parse(" 671674D6-7D14-4DC0-94A0-B1085B878C23");
